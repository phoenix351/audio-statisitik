        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-blue-400 transition-colors" id="file-drop-zone">
                        <div class="text-center">
                            <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                <i class="fas fa-file-upload text-2xl text-blue-600" aria-hidden="true"></i>
                            </div>
                            <label for="file" class="cursor-pointer">
                                <span class="text-lg font-medium text-gray-900 hover:text-blue-600 transition-colors text-sound">Pilih file atau drag & drop di sini</span>
                                <input type="file" id="file" name="file" class="sr-only" accept=".pdf,.doc,.docx" required>
                            </label>
                            ...
                            <div id="file-preview" class="hidden mt-4 p-4 bg-gray-50 rounded-lg">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button type="button" id="remove-file" class="text-red-600 hover:text-red-700 hover-sound">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-xs text-gray-500 mt-1 text-sound">Judul akan muncul di website dan hasil pencarian</p>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-xs text-gray-500 mt-1 text-sound">Pilih indikator yang paling sesuai dengan konten dokumen</p>
                        </div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-purple-400 transition-colors text-center" id="cover-drop-zone">
                            <div id="cover-placeholder">
                                ...
                                <label for="cover_image" class="cursor-pointer">
                                    <span class="text-sm font-medium text-gray-900 hover:text-purple-600 transition-colors text-sound">Pilih cover</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i><span class="text-sound">Mengunggah dan memproses...</span>';
