...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600">Berita resmi statistik terkini dari BPS Sulawesi Utara dalam format audio yang mudah diakses</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
        <form method="GET" action="{{ route('documents.brs') }}" class="flex flex-wrap gap-4 items-end">
            ...
            <div class="w-32">
                ...
                <select id="year" name="year" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover-sound">
                ...
                <div class="aspect-[3/4] bg-gray-200 relative overflow-hidden">
                    ...
                    <div class="absolute top-3 left-3">
                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium 
                            ...
                            <i class="fas fa-{{ $document->type === 'publication' ? 'book' : 'newspaper' }} mr-1"></i>
                    ...
                    @if($document->hasAudio())
                        <div class="absolute top-3 right-3">
                            <div class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center" title="Audio tersedia">
    ...
    <div id="voice-navigation-controls" class="fixed bottom-4 right-4 z-40">
        <div class="flex flex-col space-y-2">
            ...
            <button id="voice-help-btn" 
                    ...
                    aria-label="Bantuan Voice Navigation"
                    title="Bantuan voice navigation (Ctrl+H)">
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-lg max-w-2xl w-full p-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-gray-700">
                            <li><code class="bg-gray-100 px-2 py-1 rounded">"Baca dokumen"</code> - Bacakan daftar dokumen</li>
                            <li><code class="bg-gray-100 px-2 py-1 rounded">"Pilih dokumen 1"</code> - Buka dokumen nomor 1</li>
                            <li><code class="bg-gray-100 px-2 py-1 rounded">"Putar dokumen 2"</code> - Putar audio dokumen 2</li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-gray-700">
                            <li><code class="bg-gray-100 px-2 py-1 rounded">"Filter tahun 2023"</code> - Filter berdasarkan tahun</li>
                            <li><code class="bg-gray-100 px-2 py-1 rounded">"Filter indikator inflasi"</code> - Filter indikator</li>
                            <li><code class="bg-gray-100 px-2 py-1 rounded">"Cari penduduk"</code> - Pencarian kata kunci</li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm text-gray-700">
                            <li><code class="bg-gray-100 px-2 py-1 rounded">"Halaman selanjutnya"</code> - Halaman berikut</li>
                            <li><code class="bg-gray-100 px-2 py-1 rounded">"Halaman sebelumnya"</code> - Halaman sebelum</li>
                ...
                <div class="mt-4 flex justify-end">
                    <button id="close-voice-modal-btn" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                        Tutup
                    </button>
                </div>
            </div>
