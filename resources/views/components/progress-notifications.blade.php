...
<div class="relative">
    <button id="progress-notification-btn"
        class="relative cursor-pointer p-2 text-gray-600 hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-md transition-colors hover-sound"
    ...
    <div id="progress-dropdown"
        ...
        <div class="px-4 py-3 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <button id="close-progress-dropdown" class="text-gray-400 hover:text-gray-600 hover-sound">
        ...
        <div class="px-4 py-3 border-t border-gray-200 bg-gray-50">
            <div class="flex justify-between items-center">
                <button id="clear-completed" class="text-xs text-gray-600 hover:text-gray-800 hover-sound">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateProgressDisplay(data) {
            ...
            // Update stats
            const processing = items.filter(item => item.status === 'processing' || (item.percentage > 0 && item
