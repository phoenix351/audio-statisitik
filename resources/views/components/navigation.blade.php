        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-6">
                ...
                <button type="button"
                    ...
                    title="Voice Search (Ctrl atau katakan 'Hai Audio Statistik')"
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" @click.away="open = false"
                        class="flex items-center text-gray-700 hover:text-blue-600 font-medium transition-colors hover-sound text-sound focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-md px-3 py-2 {{ request()->routeIs('admin.*') ? 'text-blue-600 bg-blue-50' : '' }}">
                        <i class="fas fa-user-shield mr-2" aria-hidden="true"></i>
                        <span class="text-sound">Admin</span>
                        <i class="fas fa-chevron-down ml-1 text-xs transition-transform duration-200" :class="{ 'rotate-180': open }" aria-hidden="true"></i>
                    </button>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <form action="{{ route('logout') }}" method="POST" class="inline">
                        @csrf
                        <button type="submit" class="text-gray-700 hover:text-blue-600 font-medium transition-colors hover-sound text-sound">
            ...
            <div class="border-t border-gray-200 pt-3 mt-3">
                <form action="{{ route('logout') }}" method="POST">
                    ...
                    <button type="submit"
                        ...
                        @if(auth()->user()->isAdmin()) Logout @else Keluar @endif
                    </button>
                </form>
            </div>
            @else
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('keydown', function(event) {
            // Only on pages that are not login/register
...
{{-- Alpine.js untuk dropdown functionality --}}
